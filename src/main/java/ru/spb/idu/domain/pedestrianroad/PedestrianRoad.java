package ru.spb.idu.domain.pedestrianroad;
...
@Entity
@Table(name = "ways_pedestrians")
public class PedestrianRoad extends GeometricEntity {
...
//public PedestrianRoad(/*String name/*, Integer type, Boolean illumination, Integer traffic, Integer accidents, Integer profile, Integer surface*/) {
        //this.name = name;
//        this.type = type;
