package ru.spb.idu.domain.carroad;
...
@Entity
@Table(name = "ways_cars")
public class CarRoad extends GeometricEntity {
...
//public CarRoad(/*String name/*, Integer type, Boolean illumination, Integer traffic, Integer accidents, Integer profile, Integer surface*/) {
        //this.name = name;
//        this.type = type;
